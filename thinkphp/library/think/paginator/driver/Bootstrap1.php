...
class Bootstrap1 extends Paginator
{
     ...
     * @return string
     */
    protected function getPreviousButton($text = '<i class="fa fa-chevron-left"></i>',$class = 'previous')
    {
     ...
     * @return string
     */
    protected function getNextButton($text = '<i class="fa fa-chevron-right"></i>',$class = 'next')
    {
        if (!$this->hasMore) {
            return $this->getDisabledTextWrapper($text);
        }
    ...
    {
        return '<li class="paginate_button page-item '. $class .'"><a class="page-link" href="' . htmlentities($url) . '">' . $page . '</a></li>';
    }
