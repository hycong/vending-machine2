...
class VAgent extends Validate
{
    ...
    protected $message  =   [
        ...
        'agent_mobile.require'       => '加盟商联系人电话',
        'agent_username.require'      => '请输入加盟商名称',
        'agent_password.require'       => '请输入加盟商登录密码',
    ];

    protected $scene = [
        'create'  =>  ['agent_name','agent_contacts','agent_mobile','agent_username','agent_password'],
        'edit'  =>  ['agent_name','agent_contacts','agent_mobile','agent_username'],
    ];
