...
class Orders extends Common
{
    public function index()
    {
        ...
        $map['o.o_agent_id'] = ["eq",$this->agentId];
        ...
        $goodsList = Db::name("goods")
            ->where([
                'goods_supplier_id'=>['in',[0,$this->agentId]],
            ])
            ->field("goods_id,goods_name,goods_type")
            ->select();
        self::assign('machineCode',$machine_code);
        self::assign('goodsId',$goods_id);
        self::assign('payType',$payType);
        self::assign('payStatus',$payStatus);
        self::assign('outStatus',$outStatus);
